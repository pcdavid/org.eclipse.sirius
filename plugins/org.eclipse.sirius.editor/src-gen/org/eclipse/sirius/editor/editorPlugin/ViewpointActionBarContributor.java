...
public class ViewpointActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(SiriusEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(SiriusEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {

...
public abstract class AbstractRadioButtonPropertySection extends AbstractViewpointPropertySection {
	...
	/** 
	 * <ul>Set this boolean to select the widgets to display.
	 * <li><code>True</code> for a {@link org.eclipse.swt.widgets.Group group} displaying {@link org.eclipse.swt.widgets.Button button}s</li>
	 * <li><code>False</code> to display a {@link org.eclipse.swt.custom.CLabel label} followed by the {@link org.eclipse.swt.widgets.Button button}s in a single row</li>
	 * </ul> 
	 */
	 ...
	 * @return 
	 * 			<code>True</code> if the new index value is equal to the

...
/**
 * An abstract implementation of a section with a non-editable Text and a button allowing to
 * open a {@link org.eclipse.emf.edit.ui.celleditor.FeatureEditorDialog FeatureEditorDialog}.
 */
public abstract class AbstractEditorDialogPropertySection extends AbstractViewpointPropertySection {
	...
	/**
	 * Get the {@link org.eclipse.emf.edit.provider.IItemPropertyDescriptor IItemPropertyDescriptor}
	 * for this feature.
	 *  
	 * @return
	 * 			The {@link org.eclipse.emf.edit.provider.IItemPropertyDescriptor IItemPropertyDescriptor}
	 * 			for this feature.
	 */
	 ...
	 * @return 
	 * 			<code>True</code> if the new list of values is equal to the current 

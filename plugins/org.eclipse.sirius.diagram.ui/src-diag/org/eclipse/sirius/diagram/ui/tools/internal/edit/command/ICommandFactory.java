...
/**
 * Converts {@link AbstractModelChangeOperation} into GMF-compatible
 * {@link ICommand}s.
 *
 * @author pcdavid
 */
public final class ICommandFactory {
    ...
    public static <T> ICommand createICommand(TransactionalEditingDomain ted, final AbstractModelChangeOperation<T> operation) {
        return ICommandFactory.createICommand(ted, Collections.singleton(operation));
    }
    ...
    public static <T> ICommand createICommand(TransactionalEditingDomain ted, final AbstractModelChangeOperation<T>... operations) {
        return ICommandFactory.createICommand(ted, Arrays.asList(operations));
    }
}

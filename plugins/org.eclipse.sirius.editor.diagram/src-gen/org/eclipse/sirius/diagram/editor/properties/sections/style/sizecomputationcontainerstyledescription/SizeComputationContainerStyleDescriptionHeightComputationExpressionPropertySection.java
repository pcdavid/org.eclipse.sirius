    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), SizeComputationContainerStyleDescriptionHeightComputationExpressionPropertySection.this, text.getText());
                dialog.open();

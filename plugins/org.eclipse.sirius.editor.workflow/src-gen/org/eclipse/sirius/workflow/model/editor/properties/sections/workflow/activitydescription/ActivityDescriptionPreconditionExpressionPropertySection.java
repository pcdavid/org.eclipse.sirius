...
/**
 * A section for the preconditionExpression property of a ActivityDescription object.
 */
public class ActivityDescriptionPreconditionExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return WorkflowPackage.eINSTANCE.getActivityDescription_PreconditionExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ActivityDescriptionPreconditionExpressionPropertySection.this, text.getText());
                dialog.open();

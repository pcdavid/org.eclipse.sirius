 ...
 *******************************************************************************/
package org.eclipse.sirius.workflow.model.editor.properties.sections.workflow.workflowdescription;
...
/**
 * A section for the preconditionExpression property of a WorkflowDescription object.
 */
public class WorkflowDescriptionPreconditionExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return WorkflowPackage.eINSTANCE.getWorkflowDescription_PreconditionExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), WorkflowDescriptionPreconditionExpressionPropertySection.this, text.getText());
                dialog.open();

...
/**
 * A section for the stateExpression property of a WorkflowDescription object.
 */
public class WorkflowDescriptionStateExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "StateExpression"; //$NON-NLS-1$
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), WorkflowDescriptionStateExpressionPropertySection.this, text.getText());
                dialog.open();

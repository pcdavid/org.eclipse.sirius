...
/**
 * A section for the preconditionExpression property of a SectionDescription object.
 */
public class SectionDescriptionPreconditionExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return WorkflowPackage.eINSTANCE.getSectionDescription_PreconditionExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), SectionDescriptionPreconditionExpressionPropertySection.this, text.getText());
                dialog.open();

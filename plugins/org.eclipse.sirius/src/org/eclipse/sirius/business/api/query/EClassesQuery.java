...
public class EClassesQuery {
    ...
    /**
     * Get the common {@link EClass} for all {@link EReference#getEType()}, empty
     * {@link Optional} if no common type exists. The {@link EReference} are
     ...
     *         common type exists
     */
    public Optional<EClass> getCommonTypeForReference(String referenceName) {
        Set<EStructuralFeature> eReferences = new LinkedHashSet<>();
        ...
        return new EStructuralFeaturesQuery(new ArrayList<>(eReferences)).getCommonType();
    }
}

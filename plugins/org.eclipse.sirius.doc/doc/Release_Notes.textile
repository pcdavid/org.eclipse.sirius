...
* <span class="label label-info">Modified</span> In the VSM editor, when choosing a color from a combo box in the properties view, custom-defined colors will now appear at the top of the list. Before, they were at the bottom, after the long list of predefined colors. 

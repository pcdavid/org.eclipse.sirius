...
* <span class="label label-success">Added</span> The method @org.eclipse.sirius.business.api.dialect.DialectServices.createTransientRepresentation()@ has been added. It is similar to @createRepresentation()@ except that the new representation is not stored in the session and will neither get saved or updated/refreshed automatically. 
